...
function () {
  ...
  (0, _createClass2["default"])(BotonicInputTester, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(inp) {
        var session,
            lastRoutePath,
            res,
            _args = arguments;
    ...
    key: "payload",
    value: function () {
      var _payload = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee2(inp) {
        var session,
            lastRoutePath,
            res,
            _args2 = arguments;
    ...
    key: "path",
    value: function () {
      var _path = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(inp) {
        var session,
            lastRoutePath,
            res,
            _args3 = arguments;
...
function () {
  ...
  (0, _createClass2["default"])(BotonicOutputTester, [{
    ...
    value: function text(out) {
      ...
      return (0, _unescape["default"])(_server["default"].renderToStaticMarkup(!replies ? _react["default"].createElement(_text2.Text, null, out) : _react["default"].createElement(_text2.Text, null, out, replies)));
    }
  }, {
    key: "reply",
    value: function reply(_ref) {
      ...
      if (payload) {
        return (0, _unescape["default"])(_server["default"].renderToStaticMarkup(_react["default"].createElement(_reply.Reply, {
          payload: payload
        }, text)));
      }
...
//# sourceMappingURL=botonicTester.js.map