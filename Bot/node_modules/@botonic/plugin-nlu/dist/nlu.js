...
import { getIntent, getEntities, getPrediction } from '@botonic/nlu/lib/prediction';
global.fetch = fetch;
export class NLU {
  constructor(languages) {
    return (async () => {
      ...
      await Promise.all([...Object.values(this.models).map(nlu => nlu.model), ...Object.values(this.models).map(nlu => nlu.nluData)]);
  ...
  predict(input) {
    ...
    let entities = {
      entities: getEntities(input, nluData.devEntities)
    };
    return {
      intent,
      entities
